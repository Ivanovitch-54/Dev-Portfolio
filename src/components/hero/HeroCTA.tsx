  ...
  return (
    <div className="mt-9 flex flex-col items-stretch gap-3 sm:flex-row sm:flex-wrap sm:items-center">
      ...
      <a
        ...
        className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/10 bg-white/[0.03] px-4 py-3 text-[13px] text-white/56 transition hover:border-white/18 hover:text-white sm:w-auto sm:justify-start sm:border-none sm:bg-transparent sm:px-0 sm:py-0 sm:text-sm"
      >
        <Mail size={16} />
